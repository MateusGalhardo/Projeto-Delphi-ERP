inherited frmCadProduto: TfrmCadProduto
  ...
  inherited pgcPrincipal: TPageControl
    ...
    inherited tabManutencao: TTabSheet
      ...
      object btnIncluirFornecedor: TSpeedButton
        Left = 668
        Top = 97
        Width = 23
        Height = 22
  ...
  inherited fdqryListagem: TFDQuery
    SQL.Strings = (
        ...
        'SELECT '#10'       p.produtoId,'#10'       p.nome,'#10'       p.descricao,'#10' ' +
        '      p.valor,'#10'       p.quantidade,'#10'       p.categoriaId,'#10'      ' +
        ' p.foto,'#10'       f.fornId,'#10'       c.descricao AS DescricaoCategor' +
  ...
  object QryFornecedor: TFDQuery
    ...
    object f2QryFornecedornome: TStringField
      FieldName = 'nome'
      Origin = 'nome'
      Size = 50
    end
