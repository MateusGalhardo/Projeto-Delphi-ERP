...
begin
  if oUsuario.Selecionar(fdqryListagem.FieldByName('usuarioID').AsInteger) then begin
...
begin
  ...
  inherited;
    ...
    AplicarFuncoes(oUsuario.codigo, lkpFuncao.KeyValue);
