object frmRelCadClienteFicha: TfrmRelCadClienteFicha
  ...
  object QryCliente: TFDQuery
    ...
    object f2QryClienteemail: TStringField
      FieldName = 'email'
      Origin = 'email'
      Size = 100
    end
    object f2QryClientetelefone: TStringField
      FieldName = 'telefone'
      Origin = 'telefone'
      Size = 15
    end
    object f2QryClientecep: TStringField
      FieldName = 'cep'
      Origin = 'cep'
      Size = 10
    end
    object f2QryClienteendereco: TStringField
      FieldName = 'endereco'
      Origin = 'endereco'
      Size = 60
    end
    object f2QryClientebairro: TStringField
      FieldName = 'bairro'
      Origin = 'bairro'
      Size = 40
    end
    object f2QryClientecidade: TStringField
      FieldName = 'cidade'
      Origin = 'cidade'
      Size = 50
    end
    object f2QryClienteestado: TStringField
      FieldName = 'estado'
      Origin = 'estado'
      Size = 2
    end
